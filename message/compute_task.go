...
// ComputeTaskNotification is a family of events emitted by Nova scheduler when
// placing a new workload upon one of the hypervisors.
type ComputeTaskNotification struct {
	BaseNotification `json:",inline" yaml:",inline"`
	Payload          ComputeTaskNotificationPayload `json:"payload,omitempty" yaml:"payload,omitempty"`
}

type ComputeTaskNotificationPayload struct {
	RequestSpec struct {
...
// type ComputeTaskRequestSpec struct {
// 	NumInstances       int                           `json:"num_instances,omitempty" yaml:"num_instances,omitempty"`
// 	Image              ComputeTaskImage              `json:"image,omitempty" yaml:"image,omitempty"`
// 	InstanceProperties ComputeTaskInstanceProperties `json:"instance_properties,omitempty" yaml:"instance_properties,omitempty"`
// 	InstanceType       ComputeTaskInstanceType       `json:"instance_type,omitempty" yaml:"instance_type,omitempty"`
// }
...
// 	MinRAM          int                        `json:"min_ram,omitempty" yaml:"min_ram,omitempty"`
// 	MinDisk         int                        `json:"min_disk,omitempty" yaml:"min_ram,omitempty"`
// 	Properties      ComputeTaskImageProperties `json:"properties,omitempty" yaml:"properties,omitempty"`
// }

// type ComputeTaskImageProperties struct {
// 	HwArchitecture   string `json:"hw_architecture"`
// 	HwDiskBus        string `json:"hw_disk_bus,omitempty" yaml:"hw_disk_bus,omitempty"`
// 	HwQemuGuestAgent bool   `json:"hw_qemu_guest_agent,omitempty" yaml:"hw_qemu_guest_agent,omitempty"`
// 	HwRngModel       string `json:"hw_rng_model,omitempty" yaml:"hw_rng_model,omitempty"`
...
// type ComputeTaskInstanceProperties struct {
// 	NUMATopology     interface{}            `json:"numa_topology,omitempty" yaml:"numa_topology,omitempty"`
// 	PCIRequests      ComputeTaskPCIRequests `json:"pci_requests,omitempty" yaml:"pci_requests,omitempty"`
// 	ProjectID        string                 `json:"project_id,omitempty" yaml:"project_id,omitempty"`
// 	UserID           string                 `json:"user_id,omitempty" yaml:"user_id,omitempty"`
// 	AvailabilityZone string                 `json:"availability_zone,omitempty" yaml:"availability_zone,omitempty"`
// 	UUID             string                 `json:"uuid,omitempty" yaml:"uuid,omitempty"`
...
// type ComputeTaskPCIRequests struct {
// 	Requests []interface{} `json:"requests,omitempty" yaml:"requests,omitempty"`
// }

// type ComputeTaskInstanceType struct {
// 	ID          int                           `json:"id,omitempty" yaml:"id,omitempty"`
// 	Name        string                        `json:"name,omitempty" yaml:"name,omitempty"`
// 	MemoryMb    int                           `json:"memory_mb,omitempty" yaml:"memory_mb,omitempty"`
// 	VCPUs       int                           `json:"vcpus,omitempty" yaml:"vcpus,omitempty"`
...
// 	Disabled    bool                          `json:"disabled,omitempty" yaml:"disabled,omitempty"`
// 	IsPublic    bool                          `json:"is_public,omitempty" yaml:"is_public,omitempty"`
// 	ExtraSpecs  ComputeTaskInstanceExtraSpecs `json:"extra_specs,omitempty" yaml:"extra_specs,omitempty"`
// 	Description string                        `json:"description,omitempty" yaml:"description,omitempty"`
// 	CreatedAt   string                        `json:"created_at,omitempty" yaml:"created_at,omitempty"`
// 	UpdatedAt   interface{}                   `json:"updated_at,omitempty" yaml:"updated_at,omitempty"`
// 	DeletedAt   interface{}                   `json:"deleted_at,omitempty" yaml:"deleted_at,omitempty"`
...
// type ComputeTaskInstanceExtraSpecs struct {
// 	HwCPUCores                 string `json:"hw:cpu_cores,omitempty" yaml:"hw:cpu_cores,omitempty"`
// 	HwCPUSockets               string `json:"hw:cpu_sockets,omitempty" yaml:"hw:cpu_sockets,omitempty"`
// 	HwRngAllowed               string `json:"hw_rng:allowed,omitempty" yaml:"hw_rng:allowed,omitempty"`
// 	TraitCOMPUTESTATUSDISABLED string `json:"trait:COMPUTE_STATUS_DISABLED,omitempty" yaml:"trait:COMPUTE_STATUS_DISABLED,omitempty"`
...
// FromJSON populates a ComputeTaskNotification using
// the data in the provided JSON.
func (msg *ComputeTaskNotification) FromJSON(data string) error {
	if err := json.Unmarshal([]byte(data), msg); err != nil {
		slog.Error("failure parsing compute task notification from JSON", "error", err)
		return err
	}
	return nil
}

// ToJSON returns a string representation of the ComputeTaskNotification
// in JSON format, pretty-printed or not.
func (msg *ComputeTaskNotification) ToJSON(pretty bool) (string, error) {
	var bytes []byte
	var err error
	if pretty {
		if bytes, err = json.MarshalIndent(msg, "", "  "); err != nil {
			slog.Error("failure marshaling compute task notification to JSON", "error", err)
			return "", err
		}
	} else {
	...
	slog.Debug("compute task notification marshaled to JSON")
	return string(bytes), nil

}

// ToString converts the ComputeTaskNotification into a string containing its
// JSON one-liner representation.
func (msg *ComputeTaskNotification) ToString() string {
